...
import com.googleapi.models.googlemaps;
...
public class GoogleGeoCodeActions {
	...
	@Step
	public void requestGoogleGeoWithGet() throws Exception {
	...
	/*	GsonBuilder builder = new GsonBuilder();
		...
		geoCoding = gson.fromJson(response.getBody().prettyPrint(), googlemaps.class);
		System.out.println(geoCoding);*/
	}
	
	@Step
	public void requestGoogleMapsWithGet() throws Exception {
		response = SerenityRest.given()
